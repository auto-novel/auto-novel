...
export const isTranslating = computed(() => requestCount.value > 0);
export const translationAlert = ref<'none' | 'warning' | 'error'>('none');
export const hasActiveSegFailure = ref(false);
export const clearTranslationError = () => {
  translationAlert.value = hasActiveSegFailure.value ? 'warning' : 'none';
};
